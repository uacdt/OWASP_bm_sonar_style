...
@WebServlet(value="/hash-01/BenchmarkTest01041")
public class BenchmarkTest01041 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01041") != null) {
			param = request.getHeader("BenchmarkTest01041");
		}
