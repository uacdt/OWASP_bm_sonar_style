...
@WebServlet(value="/hash-02/BenchmarkTest02042")
public class BenchmarkTest02042 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		java.util.Enumeration<String> headers = request.getHeaders("BenchmarkTest02042");
