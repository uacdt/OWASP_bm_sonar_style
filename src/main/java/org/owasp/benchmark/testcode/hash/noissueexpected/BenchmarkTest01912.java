...
@WebServlet(value="/hash-02/BenchmarkTest01912")
public class BenchmarkTest01912 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01912") != null) {
			param = request.getHeader("BenchmarkTest01912");
		}
