...
@WebServlet(value="/hash-00/BenchmarkTest00704")
public class BenchmarkTest00704 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00704");
		String param;
