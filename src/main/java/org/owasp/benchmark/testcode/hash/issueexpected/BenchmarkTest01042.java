...
@WebServlet(value="/hash-01/BenchmarkTest01042")
public class BenchmarkTest01042 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01042") != null) {
			param = request.getHeader("BenchmarkTest01042");
		}
...
"Hash Test java.security.MessageDigest.getInstance(java.lang.String) executed"
    ...
    private class Test {
		...
		String bar = sbxyz89642.append("_SafeStuff").toString();
