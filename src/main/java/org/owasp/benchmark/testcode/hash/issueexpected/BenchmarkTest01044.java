...
@WebServlet(value="/hash-01/BenchmarkTest01044")
public class BenchmarkTest01044 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01044") != null) {
			param = request.getHeader("BenchmarkTest01044");
		}
