...
public class BenchmarkTest01120 extends HttpServlet {
...
"Hash Test java.security.MessageDigest.getInstance(java.lang.String,java.security.Provider) executed"
    ...
    private class Test {
		...
		String e99915 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d99915.getBytes() ) )); // B64 encode and decode it
