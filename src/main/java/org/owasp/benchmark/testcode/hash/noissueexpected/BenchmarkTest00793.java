...
@WebServlet(value="/hash-00/BenchmarkTest00793")
public class BenchmarkTest00793 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = queryString.substring(paramLoc + paramval.length()); // 1st assume "BenchmarkTest00793" param is last parameter in query string.
