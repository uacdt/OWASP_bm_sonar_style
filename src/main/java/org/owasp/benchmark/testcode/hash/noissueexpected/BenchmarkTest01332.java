...
@WebServlet(value="/hash-01/BenchmarkTest01332")
public class BenchmarkTest01332 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (!map.isEmpty()) {
			String[] values = map.get("BenchmarkTest01332");
...
"Hash Test java.security.MessageDigest.getInstance(java.lang.String,java.lang.String) executed"
    ...
    private class Test {
		...
		String bar = sbxyz43527.append("_SafeStuff").toString();
