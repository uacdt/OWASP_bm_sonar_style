...
@WebServlet(value="/hash-00/BenchmarkTest00707")
public class BenchmarkTest00707 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00707");
		String param;
