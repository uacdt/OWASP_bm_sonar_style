...
@WebServlet(value="/hash-02/BenchmarkTest02673")
public class BenchmarkTest02673 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = scr.getTheValue("BenchmarkTest02673");
...
"Hash Test java.security.MessageDigest.getInstance(java.lang.String,java.security.Provider) executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		if (param != null && param.length() > 1) {
		    ...
		    bar = sbxyz57216.replace(param.length()-"Z".length(), param.length(),"Z").toString();
		}
