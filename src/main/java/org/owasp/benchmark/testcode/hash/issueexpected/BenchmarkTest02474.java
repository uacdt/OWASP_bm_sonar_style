...
@WebServlet(value="/hash-02/BenchmarkTest02474")
public class BenchmarkTest02474 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest02474");
		String param;
