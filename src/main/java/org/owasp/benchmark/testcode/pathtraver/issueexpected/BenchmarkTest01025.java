...
@WebServlet(value="/pathtraver-01/BenchmarkTest01025")
public class BenchmarkTest01025 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01025") != null) {
			param = request.getHeader("BenchmarkTest01025");
		}
