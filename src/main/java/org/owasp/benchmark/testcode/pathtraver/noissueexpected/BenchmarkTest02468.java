...
@WebServlet(value="/pathtraver-03/BenchmarkTest02468")
public class BenchmarkTest02468 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest02468");
		String param;
