...
public class BenchmarkTest01375 extends HttpServlet {
    ...
    private class Test {
		...
		String e33070 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d33070.getBytes() ) )); // B64 encode and decode it
