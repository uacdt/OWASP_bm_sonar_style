...
public class BenchmarkTest02452 extends HttpServlet {
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b91263.replace(b91263.length()-"Chars".length(),b91263.length(),"Chars"); //replace some of the end content
		...
		String e91263 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d91263.getBytes() ) )); // B64 encode and decode it
