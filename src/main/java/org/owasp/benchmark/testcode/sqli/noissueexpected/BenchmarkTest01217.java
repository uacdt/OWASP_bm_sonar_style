...
"Error processing request."
    ...
    private class Test {
		...
		b89502.replace(b89502.length()-"Chars".length(),b89502.length(),"Chars"); //replace some of the end content
		...
		String e89502 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d89502.getBytes() ) )); // B64 encode and decode it
