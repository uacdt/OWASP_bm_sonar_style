...
public class BenchmarkTest01469 extends HttpServlet {
    ...
    private class Test {
		...
		String e83916 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d83916.getBytes() ) )); // B64 encode and decode it
