...
//			rememberMe.setPath("/benchmark/" + this.getClass().getSimpleName());
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b82010.replace(b82010.length()-"Chars".length(),b82010.length(),"Chars"); //replace some of the end content
		...
		String e82010 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d82010.getBytes() ) )); // B64 encode and decode it
