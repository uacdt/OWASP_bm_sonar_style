...
@WebServlet(value="/weakrand-04/BenchmarkTest01948")
public class BenchmarkTest01948 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01948") != null) {
			param = request.getHeader("BenchmarkTest01948");
		}
...
"Randomness Test java.security.SecureRandom.nextBytes(byte[]) executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		if (param != null && param.length() > 1) {
		    StringBuilder sbxyz84277 = new StringBuilder(param);
		    bar = sbxyz84277.replace(param.length()-"Z".length(), param.length(),"Z").toString();
		}
