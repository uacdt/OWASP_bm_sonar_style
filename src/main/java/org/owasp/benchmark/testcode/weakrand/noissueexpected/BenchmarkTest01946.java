...
@WebServlet(value="/weakrand-04/BenchmarkTest01946")
public class BenchmarkTest01946 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01946") != null) {
			param = request.getHeader("BenchmarkTest01946");
		}
