...
"Weak Randomness Test java.security.SecureRandom.nextGaussian() executed"
    ...
    private class Test {
		...
		b43050.replace(b43050.length()-"Chars".length(),b43050.length(),"Chars"); //replace some of the end content
		...
		String e43050 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d43050.getBytes() ) )); // B64 encode and decode it
