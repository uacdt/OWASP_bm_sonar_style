...
@WebServlet(value="/weakrand-06/BenchmarkTest02718")
public class BenchmarkTest02718 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = scr.getTheValue("BenchmarkTest02718");
...
"Weak Randomness Test java.security.SecureRandom.nextGaussian() executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b49179.replace(b49179.length()-"Chars".length(),b49179.length(),"Chars"); //replace some of the end content
		...
		String e49179 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d49179.getBytes() ) )); // B64 encode and decode it
