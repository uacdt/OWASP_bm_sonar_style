...
@WebServlet(value="/weakrand-02/BenchmarkTest01196")
public class BenchmarkTest01196 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		java.util.Enumeration<String> headers = request.getHeaders("BenchmarkTest01196");
