...
@WebServlet(value="/weakrand-02/BenchmarkTest01294")
public class BenchmarkTest01294 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = request.getParameter("BenchmarkTest01294");
		if (param == null) param = "";
