...
"Weak Randomness Test java.util.Random.nextFloat() executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b40465.replace(b40465.length()-"Chars".length(),b40465.length(),"Chars"); //replace some of the end content
		...
		String e40465 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d40465.getBytes() ) )); // B64 encode and decode it
