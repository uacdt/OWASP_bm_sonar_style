...
@WebServlet(value="/weakrand-02/BenchmarkTest01200")
public class BenchmarkTest01200 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		java.util.Enumeration<String> headers = request.getHeaders("BenchmarkTest01200");
