...
"Randomness Test java.security.SecureRandom.nextBytes(byte[]) executed"
    ...
    private class Test {
		...
		b58606.replace(b58606.length()-"Chars".length(),b58606.length(),"Chars"); //replace some of the end content
		...
		String e58606 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d58606.getBytes() ) )); // B64 encode and decode it
