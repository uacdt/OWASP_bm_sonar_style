...
"Weak Randomness Test java.security.SecureRandom.nextFloat() executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		String e26751 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d26751.getBytes() ) )); // B64 encode and decode it
