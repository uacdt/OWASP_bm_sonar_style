...
@WebServlet(value="/weakrand-02/BenchmarkTest01293")
public class BenchmarkTest01293 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = request.getParameter("BenchmarkTest01293");
		if (param == null) param = "";
