...
@WebServlet(value="/weakrand-04/BenchmarkTest01954")
public class BenchmarkTest01954 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01954") != null) {
			param = request.getHeader("BenchmarkTest01954");
		}
