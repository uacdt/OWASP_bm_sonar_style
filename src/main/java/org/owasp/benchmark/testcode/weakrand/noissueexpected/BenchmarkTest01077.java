...
@WebServlet(value="/weakrand-02/BenchmarkTest01077")
public class BenchmarkTest01077 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01077") != null) {
			param = request.getHeader("BenchmarkTest01077");
		}
