...
public class BenchmarkTest00984 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		javax.servlet.http.Cookie userCookie = new javax.servlet.http.Cookie("BenchmarkTest00984", "whatever");
		userCookie.setMaxAge(60*3); //Store cookie for 3 minutes
		userCookie.setSecure(true);
		userCookie.setPath(request.getRequestURI());
		response.addCookie(userCookie);
		javax.servlet.RequestDispatcher rd = request.getRequestDispatcher("/weakrand-02/BenchmarkTest00984.html");
...
"Weak Randomness Test java.security.SecureRandom.nextDouble() executed"
    ...
    private class Test {
		...
		b50427.replace(b50427.length()-"Chars".length(),b50427.length(),"Chars"); //replace some of the end content
		...
		String e50427 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d50427.getBytes() ) )); // B64 encode and decode it
