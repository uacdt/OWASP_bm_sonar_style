...
@WebServlet(value="/weakrand-02/BenchmarkTest01078")
public class BenchmarkTest01078 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01078") != null) {
			param = request.getHeader("BenchmarkTest01078");
		}
...
"Weak Randomness Test java.security.SecureRandom.nextInt(int) executed"
    ...
    private class Test {
		...
		String bar = sbxyz97831.append("_SafeStuff").toString();
