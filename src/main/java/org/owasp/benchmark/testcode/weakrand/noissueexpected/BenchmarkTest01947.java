...
@WebServlet(value="/weakrand-04/BenchmarkTest01947")
public class BenchmarkTest01947 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01947") != null) {
			param = request.getHeader("BenchmarkTest01947");
		}
