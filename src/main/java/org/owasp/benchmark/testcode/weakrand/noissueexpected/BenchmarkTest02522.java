...
@WebServlet(value="/weakrand-05/BenchmarkTest02522")
public class BenchmarkTest02522 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest02522");
		String param;
