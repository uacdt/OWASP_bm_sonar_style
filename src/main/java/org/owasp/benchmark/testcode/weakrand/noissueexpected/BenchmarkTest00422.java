...
@WebServlet(value="/weakrand-01/BenchmarkTest00422")
public class BenchmarkTest00422 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = request.getParameter("BenchmarkTest00422");
		if (param == null) param = "";
