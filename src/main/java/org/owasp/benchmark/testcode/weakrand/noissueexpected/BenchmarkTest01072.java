...
@WebServlet(value="/weakrand-02/BenchmarkTest01072")
public class BenchmarkTest01072 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01072") != null) {
			param = request.getHeader("BenchmarkTest01072");
		}
