...
@WebServlet(value="/weakrand-04/BenchmarkTest02157")
public class BenchmarkTest02157 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = request.getParameter("BenchmarkTest02157");
		if (param == null) param = "";
