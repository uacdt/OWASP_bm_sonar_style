...
@WebServlet(value="/weakrand-01/BenchmarkTest00420")
public class BenchmarkTest00420 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = request.getParameter("BenchmarkTest00420");
		if (param == null) param = "";
