...
"Weak Randomness Test java.util.Random.nextInt() executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b60435.replace(b60435.length()-"Chars".length(),b60435.length(),"Chars"); //replace some of the end content
		...
		String e60435 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d60435.getBytes() ) )); // B64 encode and decode it
