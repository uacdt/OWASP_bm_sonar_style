...
response.setHeader("X-XSS-Protection", "0");
    ...
    private class Test {
		...
		b32762.replace(b32762.length()-"Chars".length(),b32762.length(),"Chars"); //replace some of the end content
		...
		String e32762 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d32762.getBytes() ) )); // B64 encode and decode it
