...
response.setHeader("X-XSS-Protection", "0");
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b64181.replace(b64181.length()-"Chars".length(),b64181.length(),"Chars"); //replace some of the end content
		...
		String e64181 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d64181.getBytes() ) )); // B64 encode and decode it
