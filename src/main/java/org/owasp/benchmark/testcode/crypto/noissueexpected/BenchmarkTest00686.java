...
@WebServlet(value="/crypto-00/BenchmarkTest00686")
public class BenchmarkTest00686 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00686");
		String param;
