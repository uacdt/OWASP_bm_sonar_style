...
"Crypto Test javax.crypto.Cipher.getInstance(java.lang.String) executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		b87246.replace(b87246.length()-"Chars".length(),b87246.length(),"Chars"); //replace some of the end content
		...
		String e87246 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d87246.getBytes() ) )); // B64 encode and decode it
