...
@WebServlet(value="/crypto-00/BenchmarkTest00685")
public class BenchmarkTest00685 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00685");
		String param;
		...
		if (param != null && param.length() > 1) {
		    StringBuilder sbxyz40853 = new StringBuilder(param);
		    bar = sbxyz40853.replace(param.length()-"Z".length(), param.length(),"Z").toString();
		}
