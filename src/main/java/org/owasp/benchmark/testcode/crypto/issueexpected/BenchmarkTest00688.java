...
@WebServlet(value="/crypto-00/BenchmarkTest00688")
public class BenchmarkTest00688 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00688");
		String param;
