...
@WebServlet(value="/crypto-01/BenchmarkTest01019")
public class BenchmarkTest01019 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01019") != null) {
			param = request.getHeader("BenchmarkTest01019");
		}
