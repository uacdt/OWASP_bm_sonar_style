...
@WebServlet(value="/crypto-00/BenchmarkTest00684")
public class BenchmarkTest00684 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest00684");
		String param;
