...
@WebServlet(value="/crypto-01/BenchmarkTest01015")
public class BenchmarkTest01015 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01015") != null) {
			param = request.getHeader("BenchmarkTest01015");
		}
