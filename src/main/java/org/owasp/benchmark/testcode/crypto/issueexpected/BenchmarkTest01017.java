...
"Crypto Test javax.crypto.Cipher.getInstance(java.lang.String,java.lang.String) executed"
    ...
    private class Test {
		...
		b27056.replace(b27056.length()-"Chars".length(),b27056.length(),"Chars"); //replace some of the end content
		...
		String e27056 = new String( org.apache.commons.codec.binary.Base64.decodeBase64(
		    org.apache.commons.codec.binary.Base64.encodeBase64( d27056.getBytes() ) )); // B64 encode and decode it
