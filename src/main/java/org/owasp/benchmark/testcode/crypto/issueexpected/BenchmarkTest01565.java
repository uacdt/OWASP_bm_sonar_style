...
@WebServlet(value="/crypto-01/BenchmarkTest01565")
public class BenchmarkTest01565 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] values = request.getParameterValues("BenchmarkTest01565");
		String param;
