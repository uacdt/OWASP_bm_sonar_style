...
@WebServlet(value="/crypto-01/BenchmarkTest01147")
public class BenchmarkTest01147 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		java.util.Enumeration<String> headers = request.getHeaders("BenchmarkTest01147");
...
"Crypto Test javax.crypto.Cipher.getInstance(java.lang.String,java.security.Provider) executed"
    ...
    private class Test {
		...
		if (param != null && param.length() > 1) {
		    ...
		    bar = sbxyz71288.replace(param.length()-"Z".length(), param.length(),"Z").toString();
		}
