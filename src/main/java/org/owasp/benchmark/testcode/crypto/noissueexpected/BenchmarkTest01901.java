...
@WebServlet(value="/crypto-02/BenchmarkTest01901")
public class BenchmarkTest01901 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String param = "";
		if (request.getHeader("BenchmarkTest01901") != null) {
			param = request.getHeader("BenchmarkTest01901");
		}
...
"Crypto Test javax.crypto.Cipher.getInstance(java.lang.String) executed"
	...
	private static String doSomething(HttpServletRequest request, String param) throws ServletException, IOException {
		...
		String bar = sbxyz69308.append("_SafeStuff").toString();
